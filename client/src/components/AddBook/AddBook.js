...
function AddBook() {
  ...
  return (
    ...
    <div class="AddBook">
      ...
      <div id="authentication-modal" tabindex="-1" className={
        showModal
        ...
        <div class="relative w-full max-w-md max-h-full">
          ...
          <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <button
              ...
              type="button"
              class=" close-icon close-icon-book absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white"
            ...
            <form class="space-y-6" action="#" onSubmit={handleFormSubmit}>
